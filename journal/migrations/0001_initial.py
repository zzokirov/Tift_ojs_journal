    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('author', 'Muallif'), ('reviewer', 'Taqrizchi'), ('editor', 'Muharrir')], default='author', max_length=10)),
                ('institution', models.CharField(blank=True, max_length=255, verbose_name="Ish/O'qish joyi")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('submitted', 'Yuborildi'), ('under_review', 'Taqriz jarayonida'), ('accepted', 'Qabul qilindi'), ('rejected', 'Rad etildi'), ('published', 'Chop etildi')], default='submitted', max_length=15, verbose_name='Maqola holati')),
                ('pdf_file', models.FileField(upload_to=journal.models.article_upload_path, verbose_name='PDF Fayl')),
                ...
                ('issue', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='articles', to='journal.journalissue', verbose_name='Jurnal soni')),
            ],
            options={
                'verbose_name': 'Maqola',
